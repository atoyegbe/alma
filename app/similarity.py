...
def get_users_similiraity(user1: User, user2: User) -> float:
    ...
    user1_profile = [user1.geners, user1.top_tracks, user1.top_artists, user1.top_albums]
    user2_profile = [user2.geners, user2.top_tracks, user2.top_artists, user2.top_albums]
