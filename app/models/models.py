...
class MusicProfile(SQLModel, table=True):
    ...
    top_artists: Optional[List[str]] = Field(
        default=None, sa_column=Column(ARRAY(String))
    )
    top_tracks: Optional[List[str]] = Field(
        default=None, sa_column=Column(ARRAY(String))
    )
    genres: Optional[List[str]] = Field(default=None, sa_column=Column(ARRAY(String)))

    # Extended Music Profile Data
    favorite_decades: Optional[List[str]] = Field(
        default=None, sa_column=Column(ARRAY(String))
    )
...
class Connection(SQLModel, table=True):
    ...
    compatibility_breakdown: Optional[Dict] = Field(
        default=None, sa_column=Column(JSON)
    )
    shared_genres: Optional[List[str]] = Field(
        default=None, sa_column=Column(ARRAY(String))
    )
    shared_artists: Optional[List[str]] = Field(
        default=None, sa_column=Column(ARRAY(String))
    )
    shared_tracks: Optional[List[str]] = Field(
        default=None, sa_column=Column(ARRAY(String))
    )
    ...
    connected_user: User = Relationship(
        sa_relationship_kwargs={"foreign_keys": "[Connection.connected_user_id]"}
    )
